 ...
 */
class CRM_CaremonkeyStaffSync_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_CaremonkeyStaffSync_Upgrader(
        'com.hjed.civicrm.caremonkey_staff_sync',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_CaremonkeyStaffSync_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
